package com.glozz.mechat.server.idworker.strategy;

import com.glozz.mechat.server.idworker.WorkerIdStrategy;
import com.glozz.mechat.server.idworker.utils.HttpReq;
import com.glozz.mechat.server.idworker.utils.Ip;
import com.glozz.mechat.server.idworker.utils.Props;
import com.glozz.mechat.server.idworker.utils.Util;
...
public class DefaultWorkerIdStrategy implements WorkerIdStrategy {
    ...
    private final Properties props =
            Props.tryProperties("idworker-client.properties", Util.DOT_IDWORKERS);
    ...
    private long checkAvail(long wid) {
        ...
        try {
            File idWorkerHome = Util.createIdWorkerHome();
